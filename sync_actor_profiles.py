...
SUPABASE_URL = os.environ.get('NEXT_PUBLIC_SUPABASE_URL', 'https://gvaqcosswaaywgduztgc.supabase.co')
...
def update_actor_profile(actor_id, profile_url, tmdb_person_id=None):
  ...
  try:
    ...
    print(f'Failed updating actor {actor_id}: {e}')
    return False
...
def main():
  ...
  print('==================================================')
  actors = fetch_supabase('actors?select=id,name,slug,tmdb_person_id,profile_img_url')
  ...
  print('\n==================================================')
  print(f'🎉 ACTOR HEADSHOT SYNC COMPLETE! ({updated} profiles updated)')
  print('==================================================')
