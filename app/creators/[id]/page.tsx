...
import { Play, ExternalLink, ArrowLeft, Tv, RefreshCw, Eye, Sparkles, CheckCircle2 } from 'lucide-react';
        ...
        if (!activeChan) {
          ...
          if (allChans) {
            activeChan = allChans.find((c: any) => {
              const cleanSlug = c.slug || generateCleanSlug(c.name);
              return (
                ...
                <div>
                  {video.media_item && (
                    <Link
                      ...
                      className="text-[11px] font-bold text-amber-400 hover:underline block mb-1"
                    >
